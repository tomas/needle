...
var Needle = {
  ...
  build_multipart_body: function(data, boundary, callback){
    ...
    if (typeof data != 'object') return callback(new Error("Multipart expects data as key/val object."));
  ...
  generate_part: function(name, part, boundary, callback){
    ...
    if ((part.file || part.buffer) && part.content_type){
      ...
      return_part += "\r\n\r\n";
      // return_part += (typeof part.value == 'string') ? part.value : stringify(part.value);

  ...
  tls_options.split(' ').forEach(function(key) {
    if (typeof options[key] != 'undefined') {
      if (config.http_opts.agent) { // pass option to existing agent
        ...
        // by passing { agent: false } to http.request(), a one-time use Agent is initialized
        // and used, meaning we opt out of connection pooling, but given tls options actually work

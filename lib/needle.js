...
var close_by_default = http.Agent && http.Agent.defaultMaxSockets == 5;
...
Needle.prototype.setup = function(uri, options) {
  ...
  if (close_by_default || options.connection)
...
Needle.prototype.send_request = function(count, method, uri, config, post_data, out, callback) {
  ...
  function done(err, resp, body) {
    ...
    // this doesn't seem to make a difference (check test/headers_spec.js)
    // if (request_opts.headers['Connection'] == 'close')
